...
let g:colors_name = "dark-custom"

hi Cursor                       ctermfg=16    ctermbg=222   cterm=NONE          guifg=#151718   guibg=#ffe792   gui=NONE
hi Visual                       ctermfg=NONE  ctermbg=237    cterm=NONE          guifg=NONE      guibg=#4fa5c7   gui=NONE
...
hi Normal                       ctermfg=195   ctermbg=NONE  cterm=NONE          guifg=#d4d7d6   guibg=#151718   gui=NONE
...
hi NonText                      ctermfg=188   ctermbg=NONE  cterm=NONE          guifg=#d4d7d6   guibg=#151718   gui=NONE
